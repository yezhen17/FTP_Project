...
class Ui_func(object):
    def setupUi(self, func):
        ...
        self.horizontalLayout_5.addWidget(self.downloadBtn)
        ...
        self.horizontalLayout_5.addWidget(self.downloadBar)
        self.downloadPause = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.downloadPause.setObjectName("downloadPause")
        self.horizontalLayout_5.addWidget(self.downloadPause)
        ...
        self.uploadBar = QtWidgets.QProgressBar(self.verticalLayoutWidget)
        self.uploadBar.setProperty("value", 0)
        self.uploadBar.setObjectName("uploadBar")
        self.horizontalLayout_4.addWidget(self.uploadBar)
        self.uploadPause = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.uploadPause.setObjectName("uploadPause")
        self.horizontalLayout_4.addWidget(self.uploadPause)
    ...
    def retranslateUi(self, func):
        ...
        self.downloadPause.setText(_translate("func", "Pause"))
        self.uploadButton.setText(_translate("func", "Upload"))
        self.uploadPause.setText(_translate("func", "Pause"))
